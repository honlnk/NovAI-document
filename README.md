...
- `decisions/`：已经形成的阶段性决策记录，包含技术选型、Claude Code 映射、章节格式和要素体系等。
...
| [0003 章节 txt 格式](decisions/0003-章节格式调整计划.md) | 章节正文使用 `chapters/*.txt` 的格式决策和适配计划 |
| [0004 Elements entities 分组](decisions/0004-Element要素体系优化计划.md) | `elements/entities/`、要素模板和 Agent 行为规则 |
| [0005 项目总览索引](decisions/0005-项目总览索引决策记录.md) | 是否引入项目总览索引文件的阶段性记录 |
...
| 文档 | 说明 |
| :--- | :--- |
| [真实创作复盘](archive/真实创作复盘对照.md) | 早期真实创作复盘，核心结论已被 `decisions/0004-Element要素体系优化计划.md` 吸收 |
